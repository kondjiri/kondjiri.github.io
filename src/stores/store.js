...
export const data = {
    ...
    imgDesc:"images/kfane01.jpeg",
    mail:'kondjirif@gmail.com',
    location:'Yirimadio (Bamako-Mali)',
    github:'https://github.com/kondjiri',
    linkedin:'https://www.linkedin.com/in/fane-kondjiri-16521b19a/',
    ...
    skills:{
        ...
        networking:[
            'LAN', 'WAN', 'RIP (v1 & v2)', 'OSPF', 'BGP', 'MPLS', 'ACL',' NAT', 'PAT',' IPV4', 'IPV6', 'PPP', 'AAA',' PPoE', 'VLAN', 'VTP',' DHCP', 'HDLC', 'DNS',' HTTP', 'VPN', 'TCP/IP'
        ],
        telecoms:[ 'Technologies Radio Mobiles(4G)', 'DBS & Swap d’Antenne', 'Cryptographie (Symétrique & Asymétrique)', 
        'Réseaux de Transport Numérique (MIC, PDH & SDH)', 'Fibres Optiques',
            'VoIP', 'Traitement de Signaux Numériques et Analogiques', 'IPTV', 'FTTH', 'ATM', 'RRU (5502,5508,5509)', 'RRH',' DCDU (12B,16B)', 'BBU (5900 & 3900)',
             'Antenne GSM (Hexabande,bibande, tribande)', 'RTN', 'ATN', 'Faisceau Hertzien (Liaison & Configuration)'
            ],
        informatiques:[
            'Virtualisation (Stockage, Réseaux, Application, Docker)',' Cloud Storage (OpenFiler)', 'Système Distribué', 'programmation réseaux',' Data mapping'
        ],
        educations:[
            {
                id:1,
        ...
        portfolio:[
            {
                ...
                description:"Image classification is Intelligence Artficial,",
                link:"https://github.io/fane",
                technologies:"ReactJs, Javascript"
            },
            {
                id:2,
                title:"My Website",
                description:"Image classification is Intelligence Artficial,Image classification is Intelligence Artficial,Image classification is Intelligence Artficial",
                link:"https://github.io/portfolio",
                technologies:"ReactJs, Javascript"
            },
            {
                id:3,
